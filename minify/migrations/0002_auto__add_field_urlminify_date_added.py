...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'URLMinify.date_added'
        db.add_column(u'minify_urlminify', 'date_added',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, default=datetime.datetime(2016, 2, 1, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'URLMinify.date_added'
        db.delete_column(u'minify_urlminify', 'date_added')
